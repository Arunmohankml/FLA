  ...
  return (
    ...
    >
      <div className="page-shell">
        <div className="rounded-[34px] p-5 sm:p-6 lg:p-8">
          {/* Header */}
          <motion.div
          ...
          >
            <span className="inline-flex rounded-full border border-white/15 bg-white/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-white/75 backdrop-blur-sm">
              One-on-One
            </span>
            <h2 className="mt-4 font-heading text-[clamp(2.2rem,3.6vw,3.8rem)] font-medium leading-[1.0] tracking-[-0.06em] text-white">
              Private Language
              <br />
              Coaching
            </h2>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f, i) => (
              <motion.div
                ...
                className="group flex gap-4 overflow-hidden rounded-[22px] border border-white/15 bg-white/10 p-4 shadow-[0_12px_36px_rgba(0,0,0,0.12)] backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:bg-white/15"
              >
                <div className="flex size-9 shrink-0 items-center justify-center rounded-[12px] bg-white/12 text-xs font-semibold text-white ring-1 ring-white/15">
                  {f.n}
                </div>
                <div>
